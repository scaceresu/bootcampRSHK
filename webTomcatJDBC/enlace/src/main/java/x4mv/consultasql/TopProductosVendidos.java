...
@WebServlet("/productos-vendidos")
public class TopProductosVendidos extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
     ...
     ResultSet rs = stmt.executeQuery(consulta.query6)) {  // Cambia la consulta
    ...
    out.println("<title>Tabla de Productos Vendidos</title>");
    out.println("</head><body>");
    
    // Contenedor principal para aplicar estilos
    out.println("<div class='container'>");
    out.println("<h1>Tabla Dinámica de Productos mas vendidos</h1>");
    out.println("<table>");
