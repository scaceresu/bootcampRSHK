...
@WebServlet("/top-monedas")
public class TopMonedas extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
     ...
     ResultSet rs = stmt.executeQuery(consulta.query3)) {  // Cambia la consulta
    ...
    out.println("<h1>Tabla Dinámica de Monedas</h1>");
    out.println("<table>");
