...
public class RegistroProveedor extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        String sqlNextId = "SELECT COALESCE(MAX(id), 0) + 1 AS next_id FROM proveedor";
        String sqlInsert = "INSERT INTO proveedor (id, nombre, ruc, pais_id) VALUES (?, ?, ?, ?)";
        ...
        try (PrintWriter out = response.getWriter();
            ...
            try (PreparedStatement psInsert = conn.prepareStatement(sqlInsert)) {
                ...
                psInsert.setString(3, ruc);
                psInsert.setInt(4, pais_id);
