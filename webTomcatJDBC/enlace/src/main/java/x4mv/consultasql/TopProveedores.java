...
@WebServlet("/top-proveedores")
public class TopProveedores extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
     ...
     ResultSet rs = stmt.executeQuery(consulta.query4)) {  // Cambia la consulta
    ...
    out.println("<title>Tabla de Proveedores</title>");
    out.println("</head><body>");
    
    // Contenedor principal para aplicar estilos
    out.println("<div class='container'>");
    out.println("<h1>Tabla Dinámica de Proveedores</h1>");
    out.println("<table>");
