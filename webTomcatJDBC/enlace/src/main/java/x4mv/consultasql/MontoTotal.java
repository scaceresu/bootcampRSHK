...
@WebServlet("/monto-total")
public class MontoTotal extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
     ...
     ResultSet rs = stmt.executeQuery(consulta.query8)) {  // Cambia la consulta
    ...
    out.println("<h1>Tabla Dinámica de Facturas Totales</h1>");
    out.println("<table>");
